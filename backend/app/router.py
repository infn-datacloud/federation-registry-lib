...
from app.quota.api.v1.endpoints import bs_router as block_storage_quota_router_v1
...
from app.service.api.v1.endpoints import bs_router as block_storage_service_router_v1
