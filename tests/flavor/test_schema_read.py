...
from tests.flavor.schema import ExtendedSchema, PublicSchema, ReadSchemaValidation


class TestFlavorSchemaRead(ReadSchemaValidation):
    """Test flavor schemas."""

    @parametrize_with_cases("public", cases=PublicSchema)
    @parametrize_with_cases("extended", cases=ExtendedSchema)
