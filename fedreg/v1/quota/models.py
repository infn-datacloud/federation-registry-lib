...
class Quota(StructuredNode):
    ...
    project = RelationshipFrom(
        "fedreg.v1.project.models.Project", "USE_SERVICE_WITH", cardinality=One
    )
...
class BlockStorageQuota(Quota):
    ...
    service = RelationshipTo(
        "fedreg.v1.service.models.BlockStorageService", "APPLY_TO", cardinality=One
    )
...
class ComputeQuota(Quota):
    ...
    service = RelationshipTo(
        "fedreg.v1.service.models.ComputeService", "APPLY_TO", cardinality=One
    )
...
class NetworkQuota(Quota):
    ...
    service = RelationshipTo(
        "fedreg.v1.service.models.NetworkService", "APPLY_TO", cardinality=One
    )
...
class ObjectStoreQuota(Quota):
    ...
    service = RelationshipTo(
        "fedreg.v1.service.models.ObjectStoreService", "APPLY_TO", cardinality=One
    )
