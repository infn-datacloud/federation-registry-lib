...
class Service(StructuredNode):
    ...
    region = RelationshipFrom(
        "fedreg.v1.region.models.Region", "SUPPLY", cardinality=One
    )
...
class BlockStorageService(Service):
    ...
    quotas = RelationshipFrom(
        "fedreg.v1.quota.models.BlockStorageQuota", "APPLY_TO", cardinality=ZeroOrMore
    )
...
class ComputeService(Service):
    ...
    flavors = RelationshipTo(
        "fedreg.v1.flavor.models.Flavor",
        "AVAILABLE_VM_FLAVOR",
        cardinality=ZeroOrMore,
    )
    images = RelationshipTo(
        "fedreg.v1.image.models.Image",
        "AVAILABLE_VM_IMAGE",
        cardinality=ZeroOrMore,
    )
    quotas = RelationshipFrom(
        "fedreg.v1.quota.models.ComputeQuota", "APPLY_TO", cardinality=ZeroOrMore
    )
...
class NetworkService(Service):
    ...
    networks = RelationshipTo(
        "fedreg.v1.network.models.Network",
        "AVAILABLE_NETWORK",
        cardinality=ZeroOrMore,
    )
    quotas = RelationshipFrom(
        "fedreg.v1.quota.models.NetworkQuota", "APPLY_TO", cardinality=ZeroOrMore
    )
...
class ObjectStoreService(Service):
    ...
    quotas = RelationshipFrom(
        "fedreg.v1.quota.models.ObjectStoreQuota", "APPLY_TO", cardinality=ZeroOrMore
    )
