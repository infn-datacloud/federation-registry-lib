...
DOC_EXT_PROV = "Provider owning this project."
DOC_EXT_SLA = "SLA pointing to this project."
DOC_EXT_QUOTA = "Owned quotas pointing to the corresponding service (block-storage, \
    compute and network type)."
