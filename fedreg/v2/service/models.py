...
class Service(StructuredNode):
    ...
    region = RelationshipFrom(
        "fedreg.v2.region.models.Region", "SUPPLIES", cardinality=One
    )
...
class BlockStorageService(Service):
    ...
    quotas = RelationshipFrom(
        "fedreg.v2.quota.models.BlockStorageQuota", "APPLIES_TO", cardinality=ZeroOrMore
    )
...
class ComputeService(Service):
    ...
    quotas = RelationshipFrom(
        "fedreg.v2.quota.models.ComputeQuota", "APPLIES_TO", cardinality=ZeroOrMore
    )
...
class NetworkService(Service):
    ...
    quotas = RelationshipFrom(
        "fedreg.v2.quota.models.NetworkQuota", "APPLIES_TO", cardinality=ZeroOrMore
    )
...
class ObjectStoreService(Service):
    ...
    quotas = RelationshipFrom(
        "fedreg.v2.quota.models.ObjectStoreQuota", "APPLIES_TO", cardinality=ZeroOrMore
    )
